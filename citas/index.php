...
$product = new CitasController($db);

$stmt = $db->query("SELECT c.id, p.ubicacion, c2.cliente, c.fecha
    FROM citas AS c
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row">
                ...
                <div class="col">
                    <a class="btn " href="create.php">Agregar citas </a>
                </div>
            </div>
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        extract($row);  // $cliente, $ubicacion, $fecha, $id
                    ?>
                        <tr>
