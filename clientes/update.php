...
try {
    ...
    $stmt = $conn->query("SELECT * FROM clientes WHERE id = $id;");
    ...
    if ($_POST) {
        ...
        $clientes = new ClientesController($conn);

        $clientes->update($id, $cliente, $contacto);
                ...
                <div class="container mt-3">
                    ...
                    <form method="post">  
                        <div class="row mt-3 gx-5">
                            <div class="col-6">
                                <label>Cliente</label>                         
                                <input type="text" name="cliente" class="form-control" value="<?php echo($cliente['cliente'] ?? ''); ?>">
                            </div>
                            <div class="col-6">
                                <label>Contacto</label>                         
                                <input type="text" name="contacto" class="form-control" value="<?php echo($cliente['contacto'] ?? ''); ?>">
                            </div>
                        </div>
                        <div class="row gx-5">
                            <div class="col right">
