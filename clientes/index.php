<?php
	...
	$product = new ClientesController($db);
	$stmt = $product->getItems($page, $from_record_num,$records_per_page);
    	$num = $stmt->rowCount();
?>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row">
                    ...
                    <div class="col" >
                        <a class="btn " href="create.php">Agregar cliente </a>
                    </div>
                </div>
