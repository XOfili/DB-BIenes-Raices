...
if ($_POST) {
    ...
    $stmt = $propiedad->create($ubicacion, $terreno_m2, $construccion_m2, $habitaciones, $banos, $disponible, $precio, $extras, $descripcion);
}
    ...
    <body>
        ...
        <section class="" id="features">
                <div class="container mt-3">
                    <div class="row">
                         <div class="col">
                             <h1 id="titulo">Agregar propiedad</h1>
                         </div>
                    </div>
                    <form method="post">  
                        <div class="row mt-3 gx-5">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="terreno_m2" class="form-control">
                            </div>
                            <div class="col-4">
                                <label>Metros cuadrados de construcción</label>                         
                                <input type="text" name="construccion_m2" class="form-control">
                            </div>
                            <div class="col-4">
