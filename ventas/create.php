...
if ($_POST) {
    ...
    try {
        ...
        $response = $venta->create($propiedad_id, $cliente_id, $monto, $fecha);
                ...
                <div class="container mt-3">
                    ...
                    <form method="post">  
                        <div class="row mt-3 gx-5">
                            <div class="col-6">
                                <label>Monto</label>                         
                                <input type="double" name="monto" class="form-control">
                            </div>
                            <div class="col-6">
                                <label>Fecha</label>                         
